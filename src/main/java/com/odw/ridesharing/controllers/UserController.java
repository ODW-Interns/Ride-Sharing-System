...
/**
 * The UserController is called by the CommandController to handle the commands done on a User. UserController calls
 * UserFactory to create a User (Customer/Driver) and handles modifying and deleting of User object.
 */
@XmlRootElement
...
public class UserController {
     ...
     * 
     * @param typeValues_
     *            Expected input values specified under CREATE_USER_FORMAT in RuntimeConstants.
    ...
    public AbstractUser createUser(ArrayList<String> typeValues_) throws InvalidUserArgumentsException {
        ...
        throw new InvalidUserArgumentsException("Invalid arguments for create user. " + "Expected: "
                                                + RuntimeConstants.CREATE_USER_FORMAT.length + ", Actual: "
                                                + typeValues_.size());
    }
     ...
     * 
     * @param typeValues_
     *            Expected input values specified under MODIFY_USER_FORMAT in RuntimeConstants.
     * @return modifyDriver(_userID, typeValues_) User object that contain driver's info
     * @return modifyCustomer(_userID, typeValues_) User object that contain customer's info
    ...
    public AbstractUser modifyUser(ArrayList<String> typeValues_)
        ...
        if (typeValues_.size() == RuntimeConstants.MODIFY_USER_DRIVER_FORMAT.length) {
            try {
                ...
                throw new DriverNotFoundException("Driver not found in the database. DriverID Value = "
                                                  + typeValues_.get(0));
            } catch (Exception e_) {
                throw new InvalidUserArgumentsException(e_.getMessage());
            }
            ...
            try {
                ...
                throw new CustomerNotFoundException("Customer not found in the database. UserID Value = "
                                                    + typeValues_.get(0));
            } catch (Exception e_) {
                throw new InvalidUserArgumentsException(e_.getMessage());
            }
        ...
        // [TODO]: Provide expected and actual. Note that this method expects one of either two different input sizes.
        throw new InvalidUserArgumentsException("Invalid number of arguments for modify user.");
    }
     ...
     * 
     * @param typeValues
     *            Expected input values specified under DELETE_USER_FORMAT in RuntimeConstants.
     * @return userDatabase.remove(_userID) Object to be removed, will be used for logger
    ...
    public AbstractUser deleteUser(ArrayList<String> typeValues_)
        ...
        throw new InvalidUserArgumentsException("Invalid number of arguments for delete user. " + "Expected: "
                                                + RuntimeConstants.DELETE_USER_FORMAT.length + ", Actual: "
                                                + typeValues_.size());
    }
    ...
    /**
     * Return the first available driver in the user database. Sets the driver's availability to false because he/she is
    ...
    /**
     * Search the user database for the driver/customer based on the given ID, then return it
     * 
     * @param userID_
     ...
     * @param newValues_
     *            Expected input values specified under MODIFY_USER_DRIVER_FORMAT in RuntimeConstants.
    ...
    private Driver modifyDriver(int userID_, ArrayList<String> newValues_)
        ...
        try {
            ...
            throw new InvalidUserArgumentsException("Cannot modify a customer to a driver. UserID = " + userID_);
        }
    }
     ...
     *            The ID of the user to be modified.
     * @param newValues_
     *            Expected input values specified under MODIFY_USER_CUSTOMER_FORMAT in RuntimeConstants.
    ...
    private Customer modifyCustomer(int userID_, ArrayList<String> newValues_)
        ...
        try {
            ...
            throw new InvalidUserArgumentsException("Cannot modify a driver to a customer. UserID = " + userID_);
        }
    }
