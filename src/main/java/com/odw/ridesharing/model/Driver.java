...
/**
 * Driver is a concrete User that acts as an employee who uses the program to pick up a Customer. Driver has an
 * availability field that defaults to false and modified to true to pick up a Customer. Each Driver must have a valid
 * car to pick up a Customer.
 */
public class Driver extends AbstractUser {
     ...
     * 
     * @param rating_
     *            This is rating's info of the driver to be set It should range from 1 to 5
     */
     ...
     * 
     * @return carID The id of this person's car The id should be unique integer number
     */
    public int getCarID() {
        return carID;
    }
